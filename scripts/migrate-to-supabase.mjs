  ...
  if (schools.length > 0) {
    const { error } = await supabase.from("schools").insert(
      schools.map((s) => ({
        ...
        prescreen_deadline: s.prescreenDeadline,
        how_to_apply: s.howToApply,
        song_requirements: s.songRequirements,
        acting_requirements: s.actingRequirements,
        dance_requirements: s.danceRequirements,
        wild_card_requirements: s.wildCardRequirements,
        filming_notes: s.filmingNotes,
        acting_video_length: s.actingVideoLength,
        song_video_length: s.songVideoLength,
        dance_video_length: s.danceVideoLength,
        slate_requirements: s.slateRequirements,
        essay_prompts: s.essayPrompts,
