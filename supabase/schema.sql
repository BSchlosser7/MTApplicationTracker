...
create table if not exists schools (
  ...
  how_to_apply text,
  song_requirements text,
  acting_requirements text,
  dance_requirements text,
  wild_card_requirements text,
  filming_notes text,
  acting_video_length text,
  song_video_length text,
  dance_video_length text,
  slate_requirements text,
  essay_prompts text,
  general_notes text,
